...
var defaultBasePath = 'http://localhost:5000/api';
// ===============================================
...
var PartiesApi = /** @class */ (function () {
    function PartiesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PartiesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PartiesApi.prototype, "basePath", {
        get: function () {
    ...
    PartiesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PartiesApi.prototype.setApiKey = function (key, value) {
     ...
     */
    PartiesApi.prototype.listParties = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/parties';
                        ...
                        return new Promise(function (resolve, reject) {
                            localVarRequest(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "Array<Party>");
